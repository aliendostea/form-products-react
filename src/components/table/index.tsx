...
function EnhancedTableHead(props: EnhancedTableProps) {
  ...
  const createSortHandler =
    (property: keyof ProductProps) => (event: React.MouseEvent<unknown>) => {
...
function EnhancedTableToolbar(props: EnhancedTableToolbarProps) {
  const { numSelected, selected, removeItemProductFromArray } = props;

  function onClickButton() {
    removeItemProductFromArray(selected);
  }
  ...
  return (
    ...
    >
      ...
      {numSelected > 0 ? (
        <Tooltip onClick={onClickButton} title="Delete">
          <IconButton>
            <DeleteIcon />
          </IconButton>
        </Tooltip>
